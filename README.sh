...
echo "${ORANGE_TEXT}${BOLD_TEXT}      WELCOME TO bhoomika R CLOUD LAB SETUP${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
echo "${ORANGE_TEXT}${BOLD_TEXT}🔔 PLEASE SUBSCRIBE TO bhooomika R CHANNEL:${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}📺 https://www.youtube.com/@bhooomika R/videos${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo
echo "${ORANGE_TEXT}${BOLD_TEXT}🔴 PLEASE SUBSCRIBE TO bhooomika R CHANNEL:${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}📺 https://www.youtube.com/@bhoomika R/videos${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}=========================================================${RESET_FORMAT}"
